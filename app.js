(() => {
  ...
  const CURRICULUM = [
    {id:'u1', no:1, title:'الوحدة الأولى', page:17, active:true, outcomes:['قراءة قصة قراءة معبرة','تحديد الأحداث الرئيسة والتفاصيل','تعرف المفردات من السياق','تعرف الجملة الاسمية وأنواع الخبر','كتابة قصة قصيرة'], components:[
    ...
    {id:'u2', no:2, title:'الوحدة الثانية', page:33, active:false, outcomes:['قراءة نشيد قراءة معبرة','استنتاج الأفكار الرئيسة والفرعية','إبداء الرأي والمقارنة','تعرف كان وأخواتها','فهم المسموع والتحدث المنظم'], components:[
    ...
    {id:'u3', no:3, title:'الوحدة الثالثة', page:55, active:false, outcomes:['قراءة نص قراءة صحيحة','استنتاج الأفكار الرئيسة والفرعية','استخدام السياق والمصطلحات','تنظيم المعلومات كتابيًا','توظيف أدوات الربط وعلامات الترقيم'], components:[
    ...
    {id:'u4', no:4, title:'الوحدة الرابعة', page:71, active:false, outcomes:['قراءة القصيدة قراءة معبرة','استنباط المعاني والاستدلال عليها','توظيف إن وأخواتها','الهمزة المتوسطة على الألف','فهم المسموع والتحدث بالفصحى'], components:[
    ...
    {id:'u5', no:5, title:'الوحدة الخامسة', page:95, active:false, outcomes:['قراءة قصة قراءة معبرة','تعرف المفردات من السياق والمعجم','تحديد الأحداث والتفاصيل','تعرف جمع المذكر السالم','إعادة سرد قصة مع إضافة أحداث'], components:[
    ...
    {id:'u6', no:6, title:'الوحدة السادسة', page:117, active:false, outcomes:['قراءة النص قراءة معبرة','تعرف الكلمات المتضادة والمترادفة','تحديد الأفكار الرئيسة والفرعية','تعرف جمع المؤنث السالم','كتابة نص منظم وفهم المسموع'], components:[
  ...
  const MISSIONS = [
    ...
    {id:'d2-m',day:2,icon:'🎯',title:'الفكرة الرئيسة',points:10,unit:'الوحدة الأولى',lesson:'المستقبل',skill:'R_MAIN',passage:'الخطأ لا يعني نهاية التعلم؛ فعندما نحدد سببه ونصححه ونجرب مرة أخرى، يصبح الخطأ خطوة تقربنا من الإتقان.',question:'ما الفكرة الرئيسة؟',choices:['الخطأ فرصة للتعلم والتحسن.','يجب تجنب كل تجربة جديدة.','التعلم لا يحتاج إلى مراجعة.'],correct:0,hint:'اختاري الفكرة التي تشمل جميع الجمل.'},

    {id:'d3-g1',day:3,icon:'🧩',title:'الجملة الاسمية',points:10,unit:'الوحدة الأولى',lesson:'الجملة الاسمية',skill:'G_NOM',question:'أي جملة اسمية صحيحة؟',choices:['الطالبةُ مجتهدةٌ.','تكتبُ الطالبةُ.','لن تكتبَ الطالبةُ.'],correct:0,hint:'الجملة الاسمية تبدأ باسم.'},
    ...
    {id:'d3-i',day:3,icon:'⭐',title:'استقلال لغوي',points:10,unit:'الوحدة الأولى',lesson:'الجملة الاسمية',skill:'G_NOM',question:'أي جملة خبرها جملة فعلية؟',choices:['الحديقةُ جميلةٌ.','الطالبةُ تقرأُ كتابًا.','السماءُ صافيةٌ.'],correct:1,hint:'ابحثي عن خبر يتكون من فعل وما يتصل به.'},

    {id:'d4-w1',day:4,icon:'✍️',title:'بداية القصة',points:10,unit:'الوحدة الأولى',lesson:'استفد من أخطائك',skill:'W_STORY',question:'أي بداية أصلح لقصة قصيرة عن موقف تعلمتِ منه؟',choices:['في صباح يومٍ دراسي بدأتُ تجربةً جديدة، ولم أتوقع أن خطأً صغيرًا سيعلمني الكثير.','الأخطاء كثيرة جدًا.','أنا أحب المدرسة فقط.'],correct:0,hint:'البداية الجيدة تقدم زمانًا أو موقفًا وتمهد لحدث.'},
    ...
    {id:'d4-e',day:4,icon:'📝',title:'راجعي كتابتك',points:10,unit:'الوحدة الأولى',lesson:'استفد من أخطائك',skill:'W_EDIT',question:'أي جملة أكثر سلامة وترابطًا؟',choices:['تعلمتُ من خطئي، لذلك أعدتُ المحاولةَ بهدوء.','تعلمت من خطئي لذلك، أعدت المحاولة هدوء.','تعلمت خطئي لأن المحاولة.'],correct:0,hint:'راجعي المعنى وعلامة الترقيم وصحة التركيب.'},

    {id:'d5-r',day:5,icon:'🏁',title:'نبض الأسبوع',points:10,unit:'الوحدة الأولى',lesson:'مراجعة الوحدة',skill:'R_INFER',passage:'بعد أن أخفقت نور في العرض الأول، طلبت ملاحظات معلمتها، وتدربت أمام المرآة، ثم قدمت العرض مرة أخرى بثقة أكبر.',question:'ما سبب تحسن أداء نور؟',choices:['استفادت من التغذية الراجعة وتدربت.','غيرت موضوع العرض فقط.','توقفت عن المشاركة.'],correct:0,hint:'اربطي بين الأفعال التي قامت بها والنتيجة.'},
    {id:'d5-g',day:5,icon:'🧩',title:'نبض القاعدة',points:10,unit:'الوحدة الأولى',lesson:'مراجعة الوحدة',skill:'G_NOM',question:'اختاري الجملة الاسمية التي خبرها مفرد:',choices:['الكتابُ مفيدٌ.','الطالبةُ تكتبُ.','الزهرةُ تنمو سريعًا.'],correct:0,hint:'الخبر المفرد ليس جملة فعلية.'},
    {id:'d5-w',day:5,icon:'🏆',title:'قرار الكاتبة',points:10,unit:'الوحدة الأولى',lesson:'مراجعة الوحدة',skill:'W_EDIT',question:'قبل تسليم فقرتك، ما الخطوة الأجدى؟',choices:['أراجع الفكرة والترابط والإملاء وعلامات الترقيم.','أضيف جملًا كثيرة بلا حاجة.','أتجنب قراءة ما كتبت.'],correct:0,hint:'اختاري ما يساعدك على اكتشاف الخطأ وتحسين النص.'}
  ];
  ...
  function load(){
    try{
      const saved = JSON.parse(localStorage.getItem('itqanNabdProV2')||'{}');
      return {...defaults,...saved,student:{...defaults.student,...(saved.student||{}),mastery:{...defaultMastery,...((saved.student||{}).mastery||{})}}};
    }catch{return structuredClone(defaults)}
  }
  let state=load();
  const save=()=>localStorage.setItem('itqanNabdProV2',JSON.stringify(state));
  ...
  function setHeader(){
    ...
    contextPill.textContent=state.user?.role==='teacher'?'لوحة المعلمة • خامس':'خامس • الفصل الأول';
  }

  function renderHome(){
    root.innerHTML=`<section class="hero">
      <div class="hero-copy"><span class="eyebrow">مرتبطة بمنهج اللغة العربية • 2025–2026</span><h1>إتقان <span>| نبض</span></h1><p>منصة يومية تحول المنهج إلى رحلة قصيرة قابلة للقياس: <b>قراءة، مهارة لغوية، كتابة، وتحدي استقلال</b> مع نقاط وأوسمة، وفي الخلفية تتحول كل إجابة إلى بيانات تساعد المعلمة على اتخاذ قرار تدريس أدق.</p><div class="hero-actions"><button class="btn primary" id="goStudent" type="button">دخول الطالبة</button><button class="btn secondary" id="goTeacher" type="button">لوحة المعلمة</button></div><div class="tag-row" style="margin-top:18px"><span class="tag skill">6 وحدات فعلية</span><span class="tag">30 نقطة يوميًا</span><span class="tag">المهارة لا الدرجة فقط</span><span class="tag">منهج ← درس ← مهمة ← أثر</span></div></div>
      <div class="hero-visual"><img src="assets/salama-reading.jpg" alt="سلامة بالمريول الرصاصي تقرأ كتابًا"/><div class="floating">سلامة ترافق الطالبة في رحلة: أفهم ← أتدرّب ← أؤدي وحدي ⭐</div></div>
    </section>`;
  ...
  function renderStudent(){
    ...
    if(state.studentTab==='today'){
      ...
      content=`<div class="section-title"><div><h2>مهمة اليوم</h2><p>3 مهام قصيرة • 30 نقطة ممكنة • الوحدة الأولى</p></div><b>${dayCompleted()} / 3</b></div><div class="day-strip">${days.map((d,i)=>`<button class="day-btn ${state.selectedDay===i+1?'active':''}" data-day="${i+1}" type="button">${d}<br><small>${i+1}</small></button>`).join('')}</div><div class="progress-track"><div class="progress-fill" style="width:${dayProgress()}%"></div></div><div class="missions">${missionCards}</div><div class="insight-card"><b>قاعدة نبض:</b> النقاط لا تُعطى لمجرد الدخول؛ المحاولة الأولى الصحيحة تكسب أعلى نقاط، وبعد الخطأ تقل النقاط مع بقاء فرصة التعلم وإعادة المحاولة.</div>`;
    }else if(state.studentTab==='curriculum'){
      content=`<div class="section-title"><div><h2>منهجي</h2><p>خريطة الفصل الأول كما تظهر في كتاب اللغة العربية.</p></div></div><div class="curriculum-list">${CURRICULUM.map(u=>`<article class="unit-card ${u.active?'active':''}"><div class="unit-head"><div><h3>${u.title}</h3><small>تبدأ في صفحة ${u.page}</small></div><span class="status ${u.active?'green':'yellow'}">${u.active?'الوحدة الحالية':'قادمة'}</span></div><div class="component-list">${u.components.map(c=>`<span class="component">${c.type}: ${c.title} • ص ${c.page}</span>`).join('')}</div></article>`).join('')}</div>`;
    }else{
      const activeSkills=Object.entries(state.student.mastery).filter(([k])=>SKILLS[k]).sort((a,b)=>b[1]-a[1]);
      content=`<div class="grid-2"><div class="panel"><h2>نقاطي ومستواي</h2><p>كل 150 نقطة ترفعين مستوى إتقانك.</p><div class="stats" style="grid-template-columns:1fr 1fr"><div class="stat"><div class="value">${state.student.points}</div><div class="label">نقطة</div></div><div class="stat"><div class="value">${level()}</div><div class="label">المستوى</div></div></div></div><div class="panel"><h2>أوسمتي</h2><p>${state.student.points>=150?'⭐ نجمة الإتقان • ':''}${state.student.points>=300?'📚 قارئة واعية • ':''}${state.student.points>=450?'✍️ كاتبة نامية':''}${state.student.points<150?'أول وسام ينتظرك عند 150 نقطة.':''}</p></div></div><div class="panel"><h2>خريطة إتقاني</h2><div class="skill-bars">${activeSkills.map(([k,v])=>`<div class="skill-row"><strong>${SKILLS[k]}</strong><div class="progress-track"><div class="progress-fill" style="width:${v}%"></div></div><span>${v}%</span></div>`).join('')}</div></div>`;
    }
    root.innerHTML=`<section class="dashboard"><div class="welcome"><div><span class="eyebrow">الوحدة الأولى • رحلة الإتقان</span><h1>مرحبًا ${esc(state.student.name)} 🌟</h1><p>هدفك ليس جمع النقاط فقط؛ هدفك أن تثبتي أنك تستطيعين أداء المهارة وحدك.</p></div><img src="assets/salama-reading.jpg" alt="سلامة"/></div><div class="stats"><div class="stat"><div class="value">${state.student.points}</div><div class="label">مجموع النقاط</div><div class="micro">كل إجابة صحيحة تقربك</div></div><div class="stat"><div class="value">${state.student.streak} 🔥</div><div class="label">سلسلة الأيام</div><div class="micro">الاستمرار أهم من الكمال</div></div><div class="stat"><div class="value">${masteryAvg()}%</div><div class="label">متوسط الإتقان</div><div class="micro">حسب المهارات</div></div><div class="stat"><div class="value">${level()}</div><div class="label">مستواك</div><div class="micro">رحلتك الشخصية</div></div></div>${studentNav()}${content}</section>`;
  ...
  function renderTask(id){
    ...
    root.innerHTML=`<section class="task-wrap"><div class="task-card"><div class="task-meta"><span class="tag skill">${esc(m.unit)}</span><span class="tag">${esc(m.lesson)}</span><span class="tag">${esc(SKILLS[m.skill])}</span></div><h2>${esc(m.question)}</h2>${m.passage?`<div class="passage">${esc(m.passage)}</div>`:''}<div class="choices">${m.choices.map((c,i)=>`<button class="choice" data-choice="${i}" type="button">${esc(c)}</button>`).join('')}</div><div id="feedback"></div><button class="btn beige hidden" id="hintBtn" type="button">تلميح سلامة</button><div style="margin-top:16px"><button class="btn secondary" id="backTasks" type="button">العودة لمهام اليوم</button></div></div></section>`;
    ...
    root.querySelectorAll('.choice').forEach(btn=>btn.addEventListener('click',()=>{
      ...
      if(choice===m.correct){
        ...
        feedback.innerHTML=`<div class="feedback success"><b>أحسنتِ!</b> الإجابة صحيحة.${earned?` حصلتِ على <span class="score-pop">+${earned}</span> نقاط.`:' المهمة مكتملة سابقًا.'}<br>تقدمتِ في مهارة «${esc(SKILLS[m.skill])}».</div>`;
        hintBtn.classList.add('hidden');
      }else{
        btn.classList.add('wrong');setTimeout(()=>btn.classList.remove('wrong'),420);hintBtn.classList.remove('hidden');feedback.innerHTML='<div class="feedback warning"><b>محاولة جيدة.</b> ارجعي إلى معنى السؤال أو الدليل ثم حاولي مرة أخرى.</div>';
      }
    }));
    hintBtn.addEventListener('click',()=>{feedback.innerHTML=`<div class="feedback warning"><b>تلميح سلامة:</b> ${esc(m.hint)}</div>`});
  }

  function renderTeacherLogin(){
    root.innerHTML=`<section class="login-wrap"><div class="panel"><span class="eyebrow">بوابة المعلمة</span><h2>لوحة إتقان | نبض</h2><p>الدخول الحالي تجريبي إلى أن نضيف حسابات المدرسة وقاعدة البيانات المركزية.</p><form id="teacherForm" class="form-grid"><div class="field"><label for="teacherCode">الرمز التجريبي</label><input id="teacherCode" inputmode="numeric" placeholder="5555" required/></div><button class="btn primary" type="submit">دخول لوحة المعلمة</button><span class="helper">للتجربة: 5555</span></form></div></section>`;
  ...
  function renderTeacher(){
    ...
    if(state.teacherTab==='overview'){
      const all=[...DEMO_STUDENTS];if(state.student.name)all.unshift({name:state.student.name,points:state.student.points,streak:state.student.streak,avg:masteryAvg(),risk:masteryAvg()>=80?'green':masteryAvg()>=60?'yellow':'red'});
      content=`<div class="teacher-grid"><div class="data-card"><b>${all.length}</b><small>طالبات في العرض</small></div><div class="data-card"><b>73%</b><small>متوسط الإتقان</small></div><div class="data-card"><b>4</b><small>تحت 60%</small></div><div class="data-card"><b>30</b><small>نقطة يومية مستهدفة</small></div></div><div class="insight-card"><div class="section-title"><div><h2>قرار الحصة القادمة</h2><p>المنصة لا تعرض رقمًا فقط؛ تقترح موضع التدخل.</p></div><span class="status yellow">ملاحظة</span></div><p>إذا تكرر الخطأ في <b>الاستنتاج والدليل النصي</b> لدى مجموعة من الطالبات، فالتدخل المقترح: نمذجة قصيرة 5 دقائق + تدريب موجّه + سؤال مستقل جديد قبل الانتقال.</p></div><div class="table-wrap"><table class="table"><thead><tr><th>الطالبة</th><th>النقاط</th><th>السلسلة</th><th>الإتقان</th><th>القرار</th></tr></thead><tbody>${all.map(s=>`<tr><td><b>${esc(s.name)}</b></td><td>${s.points}</td><td>${s.streak}</td><td>${s.avg}%</td><td><span class="status ${s.risk}">${s.risk==='green'?'إثراء':s.risk==='yellow'?'تدريب موجّه':'تدخل مركز'}</span></td></tr>`).join('')}</tbody></table></div>`;
    }else if(state.teacherTab==='curriculum'){
      content=`<div class="section-title"><div><h2>خريطة المنهج الرسمية</h2><p>كل مكوّن مربوط بصفحة من كتاب الطالب، ثم بمهاراته ومهامه الرقمية.</p></div></div><div class="curriculum-list">${CURRICULUM.map(u=>`<article class="unit-card ${u.active?'active':''}"><div class="unit-head"><div><h3>${u.title}</h3><small>صفحة البداية: ${u.page}</small></div><span class="status ${u.active?'green':'yellow'}">${u.active?'مفعّلة الآن':'قادمة'}</span></div><div class="component-list">${u.components.map(c=>`<span class="component">${c.type}: ${c.title} • ص ${c.page}</span>`).join('')}</div><p class="muted" style="margin:0;line-height:1.8"><b>نواتج محورية:</b> ${u.outcomes.join(' • ')}</p></article>`).join('')}</div>`;
      ...
      content=`<div class="grid-2"><div class="panel"><h2>إتقان المهارات</h2><p>تتبع المهارة منفصلة عن الدرجة الكلية.</p><div class="skill-bars">${rows}</div></div><div class="panel"><h2>قاعدة القرار</h2><p><span class="status green">80% فأعلى</span> إثراء وتوسيع.</p><p><span class="status yellow">60–79%</span> تدريب موجّه ثم إعادة قياس.</p><p><span class="status red">أقل من 60%</span> إعادة تعليم بطريقة مختلفة.</p></div></div><div class="interventions"><div class="intervention red"><h3>🔴 تدخل مركز</h3><p class="muted">الاستنتاج + الدليل</p><div class="names"><span class="name-chip">جود</span><span class="name-chip">ريم</span></div></div><div class="intervention yellow"><h3>🟡 قريب من الإتقان</h3><p class="muted">ترابط الفقرة</p><div class="names"><span class="name-chip">دانة</span><span class="name-chip">نورة</span></div></div><div class="intervention green"><h3>🟢 إثراء</h3><p class="muted">تلخيص واستدلال أعمق</p><div class="names"><span class="name-chip">مريم</span><span class="name-chip">هند</span></div></div></div>`;
    }else{
      content=`<div class="grid-2"><div class="panel"><h2>تصميم مهمة جديدة</h2><p>في النسخة النهائية ستختارين: الوحدة ← الدرس ← المهارة، ثم تضيفين السؤال ومعيار التصحيح.</p><form id="builderForm" class="form-grid"><div class="field"><label>الوحدة</label><select id="bUnit">${CURRICULUM.map(u=>`<option>${u.title}</option>`).join('')}</select></div><div class="field"><label>المهارة</label><select id="bSkill">${Object.entries(SKILLS).map(([k,v])=>`<option value="${k}">${v}</option>`).join('')}</select></div><div class="field"><label>السؤال</label><textarea id="bQuestion" placeholder="اكتبي سؤال المهمة"></textarea></div><button class="btn primary" type="submit">حفظ كمسودة تجريبية</button></form></div><div class="panel"><h2>كيف تربط المهمة بالتحصيل؟</h2><p>كل إجابة تُسجل مع: <b>الطالبة، الوحدة، الدرس، المهارة، المحاولة، النقاط، ومستوى الاستقلال</b>. بهذا نستطيع لاحقًا إظهار التحسن الحقيقي لكل مهارة ومقارنة القياس القبلي بالبعدي.</p><div class="tag-row"><span class="tag skill">المحاولة الأولى = استقلال أعلى</span><span class="tag">التلميح لا يلغي التعلم</span><span class="tag">المهمة القصيرة = بيانات متكررة</span></div></div></div>`;
    }
    root.innerHTML=`<section class="dashboard"><div class="welcome"><div><span class="eyebrow">لوحة المعلمة • منهج خامس</span><h1>أ. نوف الغرينيق</h1><p>المرحلة: خامس • الفصل الدراسي الأول • القرار التدريسي مبني على بيانات المهارة.</p></div><img src="assets/salama-reading.jpg" alt="سلامة"/></div>${teacherNav()}${content}</section>`;
    root.querySelectorAll('[data-ttab]').forEach(b=>b.addEventListener('click',()=>{state.teacherTab=b.dataset.ttab;save();renderTeacher()}));
    const builder=document.getElementById('builderForm');if(builder)builder.addEventListener('submit',e=>{e.preventDefault();toast('تم حفظ الفكرة كمسودة في النسخة التجريبية')});
  }
