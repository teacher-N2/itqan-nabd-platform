(() => {
  ...
  function renderTeacher(){
    ...
    if(state.teacherTab==='overview'){
      ...
      content=`<div class="grid-2"><div class="panel"><h2>إتقان المهارات</h2><p>تُتابَع كل مهارة بصورة مستقلة عن الدرجة الكلية.</p><div class="skill-bars">${rows}</div></div><div class="panel"><h2>قاعدة القرار</h2><p><span class="status green">80% فأعلى</span> إثراء وتوسّع في المهارة.</p><p><span class="status yellow">60–79%</span> تدريب موجّه ثم إعادة قياس.</p><p><span class="status red">أقل من 60%</span> إعادة تعليم المهارة بطريقة مختلفة.</p></div></div><div class="interventions"><div class="intervention red"><h3>🔴 تدخّل علاجي مركّز</h3><p class="muted">الاستنتاج والاستدلال بالدليل النصي</p><div class="names"><span class="name-chip">جود</span><span class="name-chip">ريم</span></div></div><div class="intervention yellow"><h3>🟡 قريب من الإتقان</h3><p class="muted">ترابط الفقرة</p><div class="names"><span class="name-chip">دانة</span><span class="name-chip">نورة</span></div></div><div class="intervention green"><h3>🟢 إثراء</h3><p class="muted">تلخيص واستدلال أعمق</p><div class="names"><span class="name-chip">مريم</span><span class="name-chip">هند</span></div></div></div>`;
    }else{
